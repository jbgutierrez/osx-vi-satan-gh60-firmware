...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MO] = KEYMAP_HHKB(
      ...
      _______  , _______ , _______    , KC_BTN1 , KC_BTN2 , _______ , KC_MS_L , KC_MS_D   , KC_MS_U , KC_MS_R , KC_MS_L , KC_MS_R    , /*      ,            , */ _______ , \
      KC_MS_U  , /*      , */ _______ , _______ , _______ , _______ , _______ , _______   , _______ , _______ , _______ , KC_MS_D    , /*      , */ KC_MS_U , _______    , \
