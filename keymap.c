...
[_AR] = KEYMAP_HHKB(
  ...
  KC_UP    , /*      , */_______ , KC_DEL  , _______ , F(C_VMOD) , A_BWORD , A_FNEXT   , _______ , _______ , _______ , A_FIND     , /*      , */ KC_UP , _______    , \
  KC_LEFT , KC_DOWN  , KC_RGHT   , /*      ,         ,           ,         , */_______ , /*      ,         ,         , */ _______ , KC_LEFT , KC_DOWN  , KC_RGHT)   ,
